        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img src="<?= isset($_SESSION['orgid']) && !empty($_SESSION['orgid']) ? base_url('assets/media/logos/' . $_SESSION['orgid'] . '.png') : base_url('assets/media/logos/infinite.png') ?>" alt="image" onerror="this.onerror=null;this.src='<?= base_url('assets/media/logos/infinite.png') ?>';">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    <div class="d-flex flex-column">
                        <div class="d-flex align-items-center mb-2">
                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1"><?php echo $_SESSION['orgname']; ?></a>
                            <a href="#">
